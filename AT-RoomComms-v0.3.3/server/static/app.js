const $=s=>document.querySelector(s),$$=s=>[...document.querySelectorAll(s)];let token=localStorage.getItem('rc_token')||'',S={d:null,view:'control',feed:null,rerender:null,unread:0,unreadDM:{},unreadRoom:{},unreadOwnRoom:false,unreadVenue:false,unreadIssues:0},ws=null,wsRetry=0;
